...
if (!process.env.COOKIE_SECRET) {
  ...
  dotenv.config({ path: path.resolve(process.cwd(), 'apps/hydra-admin', '.env.local') });
  dotenv.config({ path: path.resolve(process.cwd(), 'apps/hydra-admin', '.env') });
}
...
function getKey(): Buffer {
  const secret = process.env.COOKIE_SECRET || '5404a7d62b5f4ad49f8714725c8103af407bda1b1d824da4c6712d475fbd83be';
