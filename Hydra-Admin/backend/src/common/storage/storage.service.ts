...
export class StorageService implements OnModuleInit {
  ...
  onModuleInit() {
    ...
    this.s3Client = new S3Client({
      ...
      forcePathStyle: true, // Needed for Garage/Minio
  ...
  async uploadImage(
    ...
    try {
      ...
      // Always return the backend API URL so images are served through the proxy.
      // This keeps the S3 bucket private and works regardless of public URL config.
